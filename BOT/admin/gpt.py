    ...
    #     getcc = await getmessage(message)
        ...
        if message.reply_to_message:
            ...
            try:
                ...
                invalid_message = """<b>Invalid Promote ⚠️</b>\n\n⟢ Not Found Any Valid Promote From Your Input ."""
                await message.reply_text(invalid_message)
                return

        processing_message = await message.reply_text("✦ ᴘʀᴏᴄᴇꜱꜱɪɴɢ... ✦")
        ...
        for attempt in range(max_retries):
            try:
                ...
                await processing_message.edit_text("✦ ꜰᴀɪʟᴇᴅ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ʀᴇꜱᴘᴏɴꜱᴇ. ᴛʀʏ ᴀɢᴀɪɴ ʟᴀᴛᴇʀ. ✦")
                return

        else:
            await processing_message.edit_text("✦ ᴛɪᴍᴇᴏᴜᴛ: ʀᴇǫᴜᴇꜱᴛ ᴛᴏᴏᴋ ᴛᴏᴏ ʟᴏɴɢ. ✦")
            return
