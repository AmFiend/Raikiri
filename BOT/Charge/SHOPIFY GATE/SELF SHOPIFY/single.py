...
PROXY = "154.203.43.247:5536:iiamztmy:ep0a5urdf4hw"
...
╚═══════════════════════╝"""
    ...
    if price is None:
        price = "N/A"
        response = f"""⚠️ 𝐅𝐚𝐢𝐥𝐞𝐝 𝐭𝐨 𝐯𝐚𝐥𝐢𝐝𝐚𝐭𝐞 𝐭𝐡𝐞 𝐬𝐢𝐭𝐞
━━━━━━━━━━━━━━━━━━━━━━
🌐 𝐒𝐢𝐭𝐞: {url}
⚠️ 𝙍𝙚𝙖𝙨𝙤𝙣: 𝙉𝙤 𝙧𝙚𝙟𝙚𝙘𝙩𝙞𝙤𝙣 𝙤𝙧 𝙧𝙚𝙨𝙥𝙤𝙣𝙨𝙚 𝙛𝙧𝙤𝙢 𝙨𝙚𝙧𝙫𝙚𝙧
━━━━━━━━━━━━━━━━━━━━━━"""
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ϟ 𝐓𝐨𝐭𝐚𝐥 𝐃𝐞𝐥𝐞𝐭𝐞𝐝 : {res.deleted_count} 𝐒𝐢𝐭𝐞𝐬
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
...
[ϟ] 𝗦𝘁𝗮𝘁𝘂𝘀 : {getresp['response']}
[ϟ] 𝗚𝗮𝘁𝗲 - {gateway}
━━━━━━━━━━━━━
[ϟ] Price - ({getresp.get('price','0')}$)
━━━━━━━━━━━━━
[ϟ] B𝗶𝗻 : {bin6}
