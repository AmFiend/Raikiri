    ...
    try:
        ...
        if not getcc:
            no_cc_msg = (
                ...
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                "ϟ 𝐘𝐨𝐮 𝐧𝐞𝐞𝐝 𝐭𝐨 𝐬𝐮𝐩𝐩𝐥𝐲 𝐂𝐂 𝐢𝐧 𝐭𝐡𝐞 𝐦𝐞𝐬𝐬𝐚𝐠𝐞\n"
                "ϟ 𝐔𝐬𝐞 /𝐬𝐩 𝐜𝐜|𝐦𝐞𝐬|𝐚𝐧𝐨|𝐜𝐯𝐯\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
            )
        ...
        if not site:
            no_site_found_msg = (
                ...
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                "ϟ 𝐘𝐨𝐮 𝐝𝐨𝐧'𝐭 𝐡𝐚𝐯𝐞 𝐚𝐧𝐲 𝐬𝐢𝐭𝐞 𝐚𝐝𝐝𝐞𝐝\n"
                "ϟ 𝐔𝐬𝐞 𝐭𝐡𝐞 /𝐬𝐞𝐭𝐮𝐫𝐥 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐭𝐨 𝐚𝐝𝐝 𝐨𝐧𝐞\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
            )
        ...
        finalresp = (
            ...
            f"[ϟ] 𝗦𝘁𝗮𝘁𝘂𝘀 : {getresp['response']}\n"
            f"[ϟ] 𝗚𝗮𝘁𝗲 - (Self Shopify)\n"
            "━━━━━━━━━━━━━\n"
            f"[ϟ] Price - ({getresp.get('price', '0')} $)\n"
            "━━━━━━━━━━━━━\n"
            f"[ϟ] B𝗶𝗻 : {bin6}\n"
            f"[ϟ] 𝗖𝗼𝘂𝗻𝘁𝗿𝘆 : {country} {flag}\n"
            f"[ϟ] 𝗜𝘀𝘀𝘂𝗲𝗿 : {bank}\n"
            f"[ϟ] 𝗧𝘆𝗽𝗲 : {brand} | {type_}\n"
            "━━━━━━━━━━━━━\n"
            f"[ϟ] T/t : {time.perf_counter() - time.perf_counter():.2f}s | Proxy : {proxy_status}\n"
            f"[ϟ] 𝗖𝗵𝗲𝗰𝗸𝗲𝗱 𝗯𝘆: <a href='tg://user?id={message.from_user.id}'>{message.from_user.first_name}</a> [ {role} ]\n"
            f"[ϟ] 𝗢𝘄𝗻𝗲𝗿: {owner_link}\n"
            "╚━━━━━━━━━━━╝\n"
        )
...
async def remove_all_sites(Client, message):
    ...
    reply_msg = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"ϟ 𝐓𝐨𝐭𝐚𝐥 𝐃𝐞𝐥𝐞𝐭𝐞𝐝 : {res.deleted_count} 𝐒𝐢𝐭𝐞𝐬\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    )
...
async def check_user_stored_sites(Client, message):
    ...
    if not sites:
        no_sites_msg = (
            ...
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "ϟ 𝐘𝐨𝐮 𝐝𝐨𝐧'𝐭 𝐡𝐚𝐯𝐞 𝐚𝐧𝐲 𝐬𝐭𝐨𝐫𝐞𝐝 𝐬𝐢𝐭𝐞𝐬\n"
            "ϟ 𝐔𝐬𝐞 /𝐬𝐞𝐭𝐮𝐫𝐥 𝐭𝐨 𝐚𝐝𝐝 𝐬𝐭𝐨𝐫𝐞𝐬\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        )
