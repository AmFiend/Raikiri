...
async def mchkfunc(fullcc, user_id):
    ...
    for attempt in range(retries):
        try:
            ...
            payflow = PayflowAuth()
            result, _ = payflow.main(fullcc)  # call blocking sync method
...
@Client.on_message(filters.command("mpf", [".", "/"]))
...
"""
        ...
        while works:
            ...
            for result_text in results:
                ...
                # Extract status and response from result_text using regex
...
"""
        ...
        # After all cards processed append summary footer once
        text += f"""
━━━━━━━━━━━━━
