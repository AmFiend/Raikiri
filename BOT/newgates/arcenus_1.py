...
@Client.on_message(filters.command("arcenus", [".", "/"]))
async def arcenus_cmd(Client, message):
    try:
        ...
        endpoint_url = "https://onyxenvbot.up.railway.app/arcenus/key=yashikaaa/cc=4100400157539308|08|2026|126"
        ...
        if getcc == False:
            resp = f"""<b>\nGate Name: {gateway} ♻️\nCMD: /arcenus\n\nMessage: No CC Found in your input ❌\n\nUsage: /arcenus cc|mes|ano|cvv</b>"""
