...
@Client.on_message(filters.command("shopify", [".", "/"]))
async def shopify_cmd(Client, message):
    try:
        ...
        endpoint_url = "https://onyxenvbot.up.railway.app/shopify/key=yashikaaa/cc=4100400157539308|08|2026|126"
        ...
        if getcc == False:
            resp = f"""<b>\nGate Name: {gateway} ♻️\nCMD: /shopify\n\nMessage: No CC Found in your input ❌\n\nUsage: /shopify cc|mes|ano|cvv</b>"""
