...
@Client.on_message(filters.command("skbased", [".", "/"]))
async def sk_based_cmd(Client, message):
    try:
        ...
        gateway = "SK Based 10$ 🔑"
        endpoint_url = "https://onyxenvbot.up.railway.app/sk/key=yashikaaa/cc=4100400157539308|08|2026|126"
        ...
        if getcc == False:
            resp = f"""<b>\nGate Name: {gateway} ♻️\nCMD: /skbased\n\nMessage: No CC Found in your input ❌\n\nUsage: /skbased cc|mes|ano|cvv</b>"""
