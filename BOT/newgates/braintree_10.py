...
@Client.on_message(filters.command("braintree", [".", "/"]))
async def braintree_cmd(Client, message):
    try:
        ...
        endpoint_url = "https://onyxenvbot.up.railway.app/braintree/key=yashikaaa/cc=4100400157539308|08|2026|126"
        ...
        if getcc == False:
            resp = f"""<b>\nGate Name: {gateway} ♻️\nCMD: /braintree\n\nMessage: No CC Found in your input ❌\n\nUsage: /braintree cc|mes|ano|cvv</b>"""
